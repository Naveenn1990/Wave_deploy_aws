...
router.get("/verified-providers-wallet", adminAuth, adminController.getVerifiedProvidersWithWallet);
router.get("/applied-providers-pagination", adminAuth, adminController.getAppliedProvidersWithPagination);
router.get(
  "/partners/:partnerId",
  adminAuth,
...
router.put('/updatePartnerBankDetails/:id', adminAuth, adminServiceController.updatePartnerBankDetails);
router.put('/updatePartnerProfileImage/:id', upload.single('profilePicture'), adminAuth, adminServiceController.updatePartnerProfileImage);
router.put('/updatePartnerServices/:id', adminAuth, adminServiceController.updatePartnerServices);
